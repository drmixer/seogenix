...
// Source logo component with consistent large size and visibility
const SourceLogo: React.FC<{ sourceType: string; className?: string }> = ({ sourceType, className = "w-6 h-6" }) => {
  const normalizedSource = sourceType.toLowerCase();
  
  if (normalizedSource.includes('google')) {
    return (
      <div className={`${className} flex items-center justify-center bg-white rounded-full p-1.5 shadow-md border border-gray-200`}>
  ...
  if (normalizedSource.includes('reddit')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#FF4500] rounded-full p-1.5`}>
  ...
  if (normalizedSource.includes('news') || normalizedSource.includes('article')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#1a73e8] rounded-full p-1.5`}>
  ...
  if (normalizedSource.includes('twitter') || normalizedSource.includes('x.com')) {
    return (
      <div className={`${className} flex items-center justify-center bg-black rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('linkedin')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#0077b5] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('youtube')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#FF0000] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('facebook')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#1877F2] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('github')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#333] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('stackoverflow') || normalizedSource.includes('stack overflow')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#F58025] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  if (normalizedSource.includes('quora')) {
    return (
      <div className={`${className} flex items-center justify-center bg-[#B92B27] rounded-full p-1.5`}>
        <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
  ...
  return (
    <div className={`${className} flex items-center justify-center bg-gray-500 rounded-full p-1.5`}>
      <svg viewBox="0 0 24 24" className="w-full h-full" fill="white">
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                    <div className="flex items-center">
                      <SourceLogo sourceType="Google" className="w-6 h-6 mr-3" />
